set run_dt_start = 2022-11-01;
  create table if not exists tab_tb2_1
  ...
  col_s_1,
   ...
   from
   (
	select a.col_s_1,case when col_s_c_d_i ='d' then col_s_t_d else null end as col_s_t_d ,
	ceiling(months_between(cast('${hiveconf:run_dt_start}' as date), cast(b.col_s_t_d as date))) as col_t_m,
	b.col_s_c_d_i,b.col_s_t_u_a
   	from ${hiveconf:db}.tab_oab as a

   inner join c_db.tab_c_gt b

   on a.col_s_1*1=b.col_s_s_1*1
